...
En utveckling mot en allt äldre befolkning skapar arbetskraftsbrist, vilket är en trend som kan observeras på många håll i landet (länka till Tillväxtverket, 2024). Därutöver kan även kompetensbrist uppstå, om de som står till arbetsmarknadens förfogande inte har de kompetenser som efterfrågas.
...
<span class="kommentar">Vilka diagram kring den generella utvecklingen ska vi ha i rapporten? 

	Befolkningsutveckling över tid
	Utveckling av arbetsföra över tid
	Flyttnetto över tid
	Försörjningskvot och prognos för framtiden
...
I fortsättningen av denna rapport redovisas först efterfrågan respektive utbud på arbetskraft i Dalarna. Därefter studeras de olika utbildningsnivåerna i Dalarna mer ingående, följt av en diskussion om hur väl arbetsmarknaden i Dalarna fungerar. Rapporten avslutas med fördjupningar på branschnivå.  
