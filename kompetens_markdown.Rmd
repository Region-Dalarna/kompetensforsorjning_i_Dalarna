...
För utrikes födda, det högra diagrammet i figur 32 nedan, är bilden annorlunda. Utrikes födda män har en högre sysselsättningsgrad än utrikes födda kvinnor i samtliga län. I Dalarna var sysselsättningsgraden bland utrikes födda män ungefär `r syss_grad_Dalarna_senaste_utrikes_man` procent, vilket
är cirka `r syssgrad_Dalarna_senaste_utrikes_skillnad_kon ` procentenheter mer än för utrikes födda kvinnor.
...
Sysselsättningsgraden för utrikes födda män skiljer sig dock åt mellan kommuner där den högsta sysselsättningsgraden finns i `r syssgrad_kommun_hogst_man_utrikes` (cirka `r syssgrad_kommun_hogst_man_utrikes_varde` procent) och den lägsta i `r syssgrad_kommun_lagst_man_utrikes` (cirka `r syssgrad_kommun_lagst_man_utrikes_varde`
procent).

Skillnaderna mellan utrikes födda kvinnor och män är mer synliga mellan kommuner i Dalarna än när länen som helhet jämförs. `r syssgrad_kommun_hogst_kvinnor_utrikes` har den högsta sysselsättningsgraden för gruppen utrikes födda kvinnor, cirka `r syssgrad_kommun_hogst_kvinnor_utrikes_varde` procent, och ligger klart över genomsnittet för Dalarnas län (ungefär `r syssgrad_dalarna_utrikes_kvinnor` procent). Samtidigt är sysselsättningsgraden bland utrikes födda kvinnor i  `r syssgrad_kommun_lagst_kvinnor_utrikes` kommun bara `r syssgrad_kommun_lagst_kvinnor_utrikes_varde` procent. 
...
<br>
Över tid har sysselsättningsgraden för personer i arbetsför ålder i Dalarna ökat bland både kvinnor och män. Mellan `r syssgrad_93_forsta_ar` och `r syssgrad_93_senaste_ar` ökade sysselsättningsgraden från ungefär 70 procent för båda könen till cirka `r syssgrad_93_senaste_ar_kvinna_varde` procent för kvinnor och `r syssgrad_93_senaste_ar_man_varde` procent för män.
...
<span class= "kommentar">Ta bort? Data uppdateras inte längre. Alternativet är data från AKU som används i integrationsrapporten bland annat</span>
