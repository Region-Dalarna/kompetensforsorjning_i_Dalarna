...
<details style = "background-color: #c5e9e2">
...
```{r, echo=FALSE, message = FALSE, warning = FALSE}
 ...
 befolkning_utb_sum <- befolkning_utb_alder_df %>%
...
#         mutate(andel=round((antal/sum(antal))*100,2)) 
  ...
  diagram_titel <- paste0("Befolkningens (20-64 år) utbildningsnivå i Dalarnas län ", unique(befolkning_utb_alder_df$Ar))
  diagramfil <- "fodelseregion_utbildning.png"
  
  utb_bakgrund_fig <- SkapaStapelDiagram(skickad_df = befolkning_utb_sum %>% 
