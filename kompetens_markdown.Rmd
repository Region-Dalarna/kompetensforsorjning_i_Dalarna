...
Under andra kvartalet `r lediga_jobb_senaste_ar` fanns det cirka `r antal_lediga_jobb` lediga jobb. Ungefär `r andel_privat_lediga_jobb` procent av dessa fanns inom privat sektor. Efterfrågan inom offentlig sektor har minskat markant på senare år, vilket sannolikt har att göra med att många aktörer inom offentlig sektor har fått sämre ekonomin på senare år och i flera fall infört anställningsstopp.
...
I Dalarna är den klart största branschen, sett till antalet förvärvsarbetande, `r tolower(bransch_flest_anstallda %>% dplyr::pull(bransch))` med ungefär `r format(plyr::round_any(bransch_flest_anstallda %>% dplyr::pull(Antal),1000),big.mark = " ")` anställda. Detta kan delvis förklaras med att befolkningen i Dalarna, precis som många andra glesbefolkade län, har en relativt hög medelålder, något som medför att mer vård och omsorg efterfrågas. SCB bedömer att behovet av arbetskraft inom vård och omsorg kommer att öka i takt med en åldrande befolkning, särskilt inom äldreomsorgen (<a href="https://www.scb.se/contentassets/3c424ebe4366403da0d30dfba52fba87/uf0515_2023a01_br_am85br2401.pdf/" target="_blank">SCB, 2024</a>).
...
<span class = "kommentar">Går figuren nedan att uppdatera? Ändrade dessutom från figuren som heter _transparent till _vit då den förstnämnda såg märklig ut. Oklar skillnad i övrigt</span>
...
<br>
I figuren nedan blir det tydligt att de unga (0-19 år) och de i arbetsför ålder (20-64 år) har minskat sedan slutet på 1960-talet, medan de äldre (65-79 år och 80+ år) har ökat kraftigt under samma tidsperiod, en utveckling som dessutom prognostiseras fortsätta i framtiden för de allra äldsta (80+ år).
...
<span class= "kommentar">Även lite oklart varför arbetslöshet diskuteras i ett avsnitt om sysselsättningsgrad? Motivera varför det är intressant?</span>
...
I stora drag ligger matchninggraden på runt `r matchningsgrad_sverige_kvinnor` procent för kvinnor och `r matchningsgrad_sverige_man` procent för män i Sverige. Det finns vissa skillnader mellan länen, men dessa är relativt små. I Dalarna är matchningsgraden cirka `r matchningsgrad_dalarna_kvinnor` procent för kvinnor och `r matchningsgrad_dalarna_man` procent för män , vilket alltså är marginellt lägre än riket som helhet.
...
<br>
Matchningen på arbetsmarknaden tenderar att variera beroende på var man är född. I Dalarna har inrikes födda högst matchning med `r matchning_inrikes_kvinnor_dalarna` procent för kvinnor och `r matchning_inrikes_man_dalarna` procent för män. Lägst matchningsgrad för män har personer `r matchning_lagst_man_fodelseland` (cirka `r matchning_lagst_man_varde` procent), medan personer födda i områden som saknas i diagrammet nedan (`r matchning_lagst_kvinnor_fodelseland`) har lägst matchningsgrad för kvinnor (cirka `r matchning_lagst_kvinnor_varde` procent). Högst matchningsgrad har `r matchning_hogst_kon` `r matchning_hogst_fodelseland` med ungefär `r matchning_hogst_varde` procent.
...
Ytterligare en viktig aspekt av arbetsmarknaden är hur lätt det är för arbetsgivare att hitta arbetskraft med rätt kompetens. Bland Sveriges län varierar den upplevda bristen på arbetskraft relativt mycket. Lättast att hitta kompetens år `r kompetensbrist_senaste_ar` har småföretag i `r kompetensbrist_lagst_region`, där ungefär `r kompetensbirst_lagst_varde` procent av småföretagen uppger att de har brist på kompetens, att jämföra med `r kompetensbrist_hogst_region`, där ungefär `r kompetensbirst_hogst_varde` procent av småföretagen uppger att de har samma brist. I Dalarna upplever ungefär `r kompetensbrist_Dalarna` procent av småföretagarna att de har svårt att hitta arbetskraft, vilket är en ökning med `r kompetensbrist_Dalarna_forandring_2020` procentenheter sedan undersökningen som gjordes 2020.
