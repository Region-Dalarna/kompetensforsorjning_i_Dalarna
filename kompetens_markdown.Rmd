...
Under `r max(forvarvsarbetande_90_senastear$år)` som den mest dominerande näringen i Dalarna när det gäller sysselsättning, och dess betydelse har dessutom ökat något under 2010-talet. Idag jobbar ungefär `r plyr::round_any(forvarvsarbetande_90_senastear %>% filter(Näringsgren == "enh för hälso- och sjukvård, socialtjänst; veterinärer",år == max(år)) %>% .$antal,1000)` inom denna branschgrupp. Samtidigt var det inte bara inom hälso- och sjukvården som många invånare i Dalarna fann arbete; handel, transport, magasinering, kommunikation samt utvinning av mineral och tillverkningsindustri var också betydande sysselsättningssektorer under `r max(forvarvsarbetande_90_senastear$år)`. 
