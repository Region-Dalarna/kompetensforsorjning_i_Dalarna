...
Även mellan branscher varierar kvalifikationskraven av naturliga skäl. Störst andel som arbetar inom yrken av enklare karaktär återfinns i Dalarna inom hotell och restaurang, där mer än var fjärde arbetar inom den typen av yrke. Även inom 
```{r, echo=FALSE, fig.width=10, fig.align='Left',fig.cap="Figur 7"}
