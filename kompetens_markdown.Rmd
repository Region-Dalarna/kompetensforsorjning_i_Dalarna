...
Dalarna har en åldrande befolkning och aktuella prognoser från SCB pekar på en utveckling där allt färre i arbetsför ålder ska försörja allt fler äldre. Redan idag är försörjningskvoten den högsta i landet, förväntas öka över tid och skapa en brist på arbetskraft. Det här påverkar näringslivets och offentlig sektors möjlighet att rekrytera personal. 
...
Snabb teknologisk utveckling skapar behov av förändrade kompetenser samtidigt som utbildningsområdet är mer trögrörligt, vilket gör att jämvikt mellan efterfrågan och utbud blir svår att uppnå med försämrad effektivitet.Frågan om arbetskrafts- och kompetensbrist är komplex. Både arbetskraftens efterfrågan och utbud behöver studeras, men även matchningen på arbetsmarknaden. Denna rapport syftar till att belysa läget kring kompetensförsörjningen i länet och peka på ett antal utmaningar som arbetsmarknadens aktörer behöver adressera för att uppnå Dalastrategins målbild för 2030 om en väl fungerande kompetensförsörjning.
