...
Under andra kvartalet `r lediga_jobb_senaste_ar` fanns det cirka `r antal_lediga_jobb` lediga jobb. Ungefär `r andel_privat_lediga_jobb` av dessa fanns inom privat sektor. Efterfrågan inom offentlig sektor minskade markant mellan 2023 och `r lediga_jobb_senaste_ar`, vilket sannolikt har att göra med att många aktörer inom offentlig sektor fått försämrad ekonomin och flera fall infört anställningsstopp.
